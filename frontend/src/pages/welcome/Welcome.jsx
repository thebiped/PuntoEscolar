    ...
    <div className="welcome-page">
      ...
      <header className="navbar">
        ...
        <div className="nav-buttons">
          <button className="btn-link"><a href="/login">Iniciar Sesión</a></button>
          <button className="btn-primary"><a href="/registro">Comenzar</a></button>
        </div>
      </header>
      ...
      <section className="hero">
        <div className="hero-text">
          ...
          <button className="btn-hero"><div className="icon"><Rocket /></div><a href="/registro">Comenzar Ahora</a></button>
        </div>
      ...
      <section className="benefits">
        ...
        <button className="btn-benefit-card"><div className="icon"><Rocket /></div><a href="/registro">Comenzar Ahora</a></button>
      </section>
          ...
          <div className="testimonial">
            <div className="testimonial-content">
              <div className="header">
                ...
                <p><Star color="#B20003" fill="#FF2FEE" size={18} /> <Star color="#B20003" fill="#FF2FEE" size={18} /> <Star color="#B20003" fill="#FF2FEE" size={18} /> <Star color="#B20003" fill="#FF2FEE" size={18} /> <Star color="#B20003" fill="#FF2FEE" size={18} /></p>
              </div>
      ...
      <section className="social">
        <div className="social-header">
          ...
          <p>Seguinos en nuestras redes sociales y mantenete al día con todas las novedades</p>
        </div>
        <div className="social-container">
          <div className="social-card instagram">
            <div className="social-card-content">
              <div className="icon"><Instagram size={36} color="#fff" /></div>
              <div className="content">
                <h3>Instagram</h3>
          ...
          <div className="social-card facebook">
            <div className="social-card-content">
              <div className="icon"><Facebook size={36} color="#fff" /></div>
              <div className="content">
                <h3>Facebook</h3>
                <div className="description">
          ...
          <div className="social-card whatsapp">
            <div className="social-card-content">
              <div className="icon"><Phone size={36} color="#fff" /></div>
              <div className="content">
                <h3>WhatsApp</h3>
                <div className="description">
                  <h5>11-5555-0123</h5>
